...
class TestContainerRunner:
    ...
    @pytest.mark.asyncio
    async def test_execute_python_success(self, container_runner, sample_resource_limits, mock_container):
    ...
    @pytest.mark.asyncio
    async def test_execute_javascript_success(self, container_runner, sample_resource_limits, mock_container):
    ...
    @pytest.mark.asyncio
    async def test_execute_with_error(self, container_runner, sample_resource_limits, mock_container):
    ...
    @pytest.mark.asyncio
    async def test_execute_container_creation_failure(self, container_runner, sample_resource_limits):
        ...
        container_runner.docker_client.containers.run.side_effect = Exception("Docker error")
    ...
    async def test_resource_limits_exceeded(self, container_runner, mock_container):
        ...
        assert any("Memory limit exceeded" in violation for violation in result.resource_limits_exceeded)
    ...
    async def test_health_check_failure(self, container_runner):
        ...
        # Arrange
        container_runner.docker_client.ping.side_effect = Exception("Docker not running")
    ...
    async def test_create_workspace_javascript(self, container_runner):
        ...
        # Act
        workspace = await container_runner._create_workspace("console.log('Hello');", "javascript")
    ...
    async def test_create_workspace_powershell(self, container_runner):
        ...
        # Act
        workspace = await container_runner._create_workspace("Write-Output 'Hello'", "powershell")
