...
"""
        ...
        import_violations = [v for v in result.violations if v.rule_name == "dangerous_import"]
...
"""
        ...
        function_violations = [v for v in result.violations if v.rule_name == "dangerous_function"]
...
"""
        ...
        js_violations = [v for v in result.violations if "JavaScript" in v.message or "dangerous" in v.message.lower()]
...
"""
        ...
        bash_violations = [v for v in result.violations if "Bash" in v.message or "bash" in v.message.lower()]
