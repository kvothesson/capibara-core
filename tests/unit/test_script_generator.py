...
from capibara.core.script_generator import ScriptGenerator, ScriptGenerationError
from capibara.llm_providers.base import LLMResponse
...
class TestScriptGenerator:
    ...
    @pytest.mark.asyncio
    async def test_generate_script_success(self, script_generator, mock_fallback_manager):
    ...
    @pytest.mark.asyncio
    async def test_generate_script_with_provider_preference(self, script_generator, mock_fallback_manager):
    ...
    @pytest.mark.asyncio
    async def test_generate_script_failure(self, script_generator, mock_fallback_manager):
    ...
    def test_validate_javascript_syntax(self, script_generator):
        ...
        result = script_generator._validate_javascript_syntax(valid_js)
