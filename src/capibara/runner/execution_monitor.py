...
class ExecutionMonitor:
    ...
    def end_execution(self, execution_id: str) -> Optional[ExecutionMetrics]:
        ...
        logger.debug("Ended execution monitoring", 
    ...
    def clear_completed_executions(self) -> int:
        ...
        completed_ids = [
            exec_id for exec_id, metrics in self.active_executions.items()
