...
class HealthCheck:
    ...
    def __init__(self, name: str, critical: bool = False):
        ...
        self.check_duration_ms: float | None = None
    ...
    async def check(self) -> dict[str, Any]:
        ...
        try:
            ...
            result = {"status": self.last_status.value, "error": str(e)}
...
class LLMProvidersHealthCheck(HealthCheck):
    ...
    async def _perform_check(self) -> dict[str, Any]:
        ...
        healthy_providers = sum(
            1 for p in providers_status.values() if p.get("status") == "healthy"
        )
        total_providers = len(
            [
                p
                for p in providers_status.values()
...
class SecurityPoliciesHealthCheck(HealthCheck):
    ...
    async def _perform_check(self) -> dict[str, Any]:
        ...
        try:
            ...
            # Count policy files
            policy_files = list(policies_path.glob("*.yaml")) + list(
...
class HealthChecker:
    ...
    def __init__(self) -> None:
        ...
        self.last_overall_check: datetime | None = None
    ...
    async def check_all(self) -> dict[str, Any]:
        ...
        self.last_overall_check = datetime.now(UTC)
        ...
        return {
            ...
            "summary": {
                ...
                "unhealthy": len(
                    [r for r in results if r.get("status") == "unhealthy"]
                ),
    ...
    def get_last_status(self) -> dict[str, Any]:
        ...
        time_since_last = datetime.now(UTC) - self.last_overall_check
